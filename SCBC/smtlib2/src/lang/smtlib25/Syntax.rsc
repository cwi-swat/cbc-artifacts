...
syntax Command 
	...
	| @Foldable defineFunction:	"(" "define-fun" FunctionId name "(" SortedVar* params ")" Sort returnSort Formula body ")"  
...
syntax Formula = updateField: "(" "(" "_" "update-field" QualifiedId fieldName ")" QualifiedId recordValue Formula newValue ")";
...
lexical FunctionId = [=-*/\>\<][=]? | Id; // to allow overloading
lexical Id = ([a-zA-Z0-9_.] !<< [a-zA-Z_][a-zA-Z0-9_.\-+]* !>> [a-zA-Z0-9 _.]) \ Keywords;
